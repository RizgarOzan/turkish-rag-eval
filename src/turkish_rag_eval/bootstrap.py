...
def passes_agree(first: str, second: str) -> bool:
    ...
    A token-similarity floor alone would not do. On this repository's own 180
    double-labelled questions, Jaccard overlap sits below 0.6 for 50 of them -
    yet 46 of those 50 are containment pairs. The passes were almost never
    ...
    reproduces all 180 of them exactly, including the four genuine
