...
def passes_agree(first: str, second: str) -> bool:
    ...
    A token-similarity floor alone would not do. On this repository's own 120
    double-labelled questions, Jaccard overlap sits below 0.6 for 43 of them -
    yet 39 of those 43 are containment pairs. The passes were almost never
    ...
    reproduces all 120 of them exactly, including the four genuine
